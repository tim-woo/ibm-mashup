...
$ziggyFcb = '<div class="fb-like" data-href="https://www.facebook.com/ZiggyMarley" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$barringtonFcb = '<div class="fb-like" data-href="https://www.facebook.com/barringtonlevymusic" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$marciaFcb = '<div class="fb-like" data-href="https://www.facebook.com/pages/Marcia-Griffiths/275101885876065" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$santigoldSpo = '<iframe src="https://embed.spotify.com/?uri=spotify:track:0t2QiRkpag0fAgs9zuCPlH" width="100%" height="80" frameborder="0" allowtransparency="true"></iframe>';
$santigoldTwi = '<a class="twitter-timeline" href="https://twitter.com/Santigold" data-widget-id="337416478875869185">Tweets by @Santigold</a>';
$santigoldFcb = '<div class="fb-like" data-href="https://www.facebook.com/Santigold" data-send="false" data-layout="button_count" data-width="450" data-show-faces="true" data-font="arial"></div>';
...
$grouchTwi = '';
$grouchFcb = '<div class="fb-like" data-href="https://www.facebook.com/TheGrouchandEligh" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$commonFcb = '<div class="fb-like" data-href="https://www.facebook.com/thinkcommon" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$ryanFcb = '<div class="fb-like" data-href="https://www.facebook.com/ryanmcdmusic" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$jheneSpo = '<iframe src="https://embed.spotify.com/?uri=spotify:track:21kOqnRYzuVHo2vahEcZyK" width="100%" height="80" frameborder="0" allowtransparency="true"></iframe>';
$jheneTwi = '<a class="twitter-timeline" href="https://twitter.com/JheneAiko" data-widget-id="337629717232484352">Tweets by @JheneAiko</a>';
$jheneFcb = '<div class="fb-like" data-href="https://www.facebook.com/pages/Jhene-Aiko/205547849459987" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$mrFcb = '<div class="fb-like" data-href="https://www.facebook.com/MrVegasMusic" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
$kesFcb = '<div class="fb-like" data-href="https://www.facebook.com/Kestheband" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>';
...
function twitter($artistID)
{
  switch ($artistID)
  {
  case "santigold":
    echo $GLOBALS['santigoldTwi'];
    break;
  case "common":
    echo $GLOBALS['commonTwi'];
      break;
    case "jhene":
      echo $GLOBALS['jheneTwi'];
      break;
    case "ryan":
      echo $GLOBALS['ryanTwi'];
      break;
    case "ziggy":
      echo $GLOBALS['ziggyTwi'];
      break;
    case "barrington":
      echo $GLOBALS['barringtonTwi'];
      break;
    case "mr":
      echo $GLOBALS['mrTwi'];
      break;
...
function facebook($artistID)
{
  switch ($artistID)
  {
  case "santigold":
    echo $GLOBALS['santigoldFcb'];
    break;
  case "common":
    echo $GLOBALS['commonFcb'];
      break;
  case "grouch":
      echo '';
      break;
    case "jhene":
      echo $GLOBALS['jheneFcb'];
      break;
    case "ryan":
      echo $GLOBALS['ryanFcb'];
      break;
    case "ziggy":
      echo $GLOBALS['ziggyFcb'];
      break;
    case "barrington":
      echo $GLOBALS['barringtonFcb'];
      break;
    case "mr":
      echo $GLOBALS['mrFcb'];
      break;
    case "marcia":
      echo $GLOBALS['marciaFcb'];
      break;
    case "kes":
      echo $GLOBALS['kesFcb'];
      break;
